import { BadRequestException, Controller, Get, Param, ParseIntPipe, Query, Req, Res, UseGuards } from '@nestjs/common';
import type { Request, Response } from 'express';

import { Roles, RolesGuard, Logger, ConfigService } from '../../common';
import type { Sampletable1 } from '../../entities/sampledb1';
